"""
Django settings for bddprueba project.
...
SECRET_KEY = 'django-insecure-b45km$xuc8%d0&+cw88o&yiit@+zgxw@@g%@pq#)7&zs&lz)q1'
...
WSGI_APPLICATION = 'bddprueba.wsgi.application'
